...
module.exports = {
  ...
  entry: [__dirname + "/src/main/index.js", __dirname + "/src/main/global/javascript/utils.js" , __dirname + "/src/main/global/javascript/wp.js"],
  ...
  module: {
    ...
    loaders: [
      ...
      { test: /\.less$/, exclude: /node_modules/, loaders: [ 'classnames', 'style', 'css', 'postcss', 'less' ] },
